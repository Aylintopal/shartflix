...
import 'package:shartflix/features/auth/presentation/widgets/agreement_widget.dart';
  ...
  Widget build(BuildContext context) {
    List<CustomTextFormField> fieldList = [
      CustomTextFormField(
        ...
        label: LocaleKeys.auth_page_name_surname_txt.tr(),
        prefixIcon: SvgPicture.asset(Assets.svg.user),
        validator: (value) {
          if (value == null || value.isEmpty) {
            return LocaleKeys.error_texts_name_isEmpty_txt.tr();
          }
          return null;
        },
      ),
      ...
      CustomTextFormField(
        ...
        label: LocaleKeys.auth_page_password_again_txt.tr(),
        prefixIcon: SvgPicture.asset(Assets.svg.lock),
        isPasswordField: true,
        validator: (value) {
          if (value == null || value.isEmpty) {
            ...
            return LocaleKeys.error_texts_passwords_dont_match_txt.tr();
          }
          return null;
        },
      ),
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      AppLogoWidget(),
                      AuthTitlesWidget(
                        title: LocaleKeys.auth_page_signup_txt.tr(),
                        subtitle: LocaleKeys.auth_page_signup_desc_txt.tr(),
                      ),
                      30.verticalSpace,
                      ...fieldList,
                      AgreementWidget(),
                      ...
                      CustomButton(
                        ...
                        title: LocaleKeys.auth_page_register_txt.tr(),
                        isLoading: isLoading,
                      ),
                      24.verticalSpace,
                      Row(
                      ...
                      AuthFooter(
                        title:
                            "${LocaleKeys.auth_page_do_have_an_account_txt.tr()} ",
                        subtitle: LocaleKeys.auth_page_login_txt.tr(),
